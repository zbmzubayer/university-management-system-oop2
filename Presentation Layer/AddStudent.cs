    ...
    public partial class AddStudent : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (studentDataAccess.AddStudent(student.Name, student.Email, student.DateOfBirth, student.Phone, student.Gender, student.BloodGroup, student.Address, student.Department, student.Program))
                {
